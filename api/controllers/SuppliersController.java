...
public class SuppliersController {
    ...
    @GetMapping("/{id}")
    public DataResult<GetByIdSupplierResponse> getById(@PathVariable Integer id) {
        return supplierManager.getById(id);
    }

    @PostMapping("")
    public DataResult<AddSupplierResponse> add(@Valid @RequestBody AddSupplierRequest addSupplierRequest) {
