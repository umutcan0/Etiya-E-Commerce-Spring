...
public interface CustomerDao extends JpaRepository<Customer, Integer> {
    ...
    @Query(value = "select new com.etiya.ecommerce.services.dtos.responses.customer.ListCustomerResponse(c.id,c.fullName,c.details) from Customer c")
    Slice<ListCustomerResponse> getAll(Pageable pageable);
}
